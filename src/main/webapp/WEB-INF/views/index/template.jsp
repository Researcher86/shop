...
<head>
    ...
    <link rel="icon" href="<c:url value="/public/img/eshop_icon.png"/>" type="image/x-icon">
    <link rel="shortcut icon" href="<c:url value="/public/img/eshop_icon.png"/>" type="image/x-icon">
